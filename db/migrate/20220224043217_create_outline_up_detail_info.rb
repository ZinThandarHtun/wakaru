class CreateOutlineUpDetailInfo < ActiveRecord::Migration[6.1]
  def change
    create_table :outline_up_detail_infos do |t|
      t.references :outline_up_basic_info, null: false, foreign_key: true
